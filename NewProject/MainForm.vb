...
Public Class MainForm
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles OpenButton.Click
        If XMLDialog.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
            'If XMLDialog.ShowDialog() = Me.DialogResult.OK Then
    ...
    Private Sub Run(XMLFilePath As String)
        ...
        ProcessConfig.RDM_CnStr = XML.SelectSingleNode("Process/RDM_CnStr").InnerText
